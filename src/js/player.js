...
export class Player extends Actor {
    ...
    onPreUpdate(engine) {
        ...
        onInitialize(engine) {
            ...
            // this.on('collisionstart', (event) => this.onEnterFastSwamp(event));
            // this.on('collisionend', (event) => this.onLeaveFastSwamp(event));
        ...
        // onEnterFastSwamp(event) {
        //     if (
        //         event.other instanceof SwampBackground1 ||
        //         event.other instanceof SwampBackground2 ||
        //         event.other instanceof SwampBackground3 ||
        //         event.other instanceof SwampBackground4 ||
        //         event.other instanceof SwampBackground5 ||
        //         event.other instanceof SwampBackground6 ||
        //         event.other instanceof SwampBackground7 ||
        //         event.other instanceof SwampBackground8 ||
        //         event.other instanceof SwampBackground82 ||
        //         event.other instanceof SwampBackground83 ||
        //         event.other instanceof SwampBackground9
        //     ) {
        //         // this.fastContacts++;
        //         this.fastOnSwamp = true;
        //     }
        ...
        //         event.other instanceof SwampBackground9
        //     ) {
        //         this.fastContacts = Math.max(0, this.fastContacts - 1);
        //         console.log(this.fastContacts)
        //         if (this.fastContacts === 0) {
        //             this.fastOnSwamp = false;
        //         }
        //     }
        // }
